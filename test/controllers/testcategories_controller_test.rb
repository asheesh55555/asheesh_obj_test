...
class TestcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testcategory" do
    assert_difference('Testcategory.count') do
      post testcategories_url, params: { testcategory: { testcategoryname: @testcategory.testcategoryname } }
    end
  ...
  test "should update testcategory" do
    patch testcategory_url(@testcategory), params: { testcategory: { testcategoryname: @testcategory.testcategoryname } }
